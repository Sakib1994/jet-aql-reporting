<template>
  <app-layout>
    ...
    >
      ...
      <form @submit.prevent="form.patch(route('ads-accounts.update',form))">
        <div>
...
export default {
  ...
  setup(props) {
    ...
    const form = useForm({
      ...
      aqlName: props.account.aqlName,
      accountId: props.account.accountId,
      platform: props.account.platform,
      monthlyBudget: props.account.monthlyBudget,
      dailyBudget: props.account.dailyBudget,
    });
